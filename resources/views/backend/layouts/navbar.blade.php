<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-picture-o"></i> <span class="nav-label">Slider İşlemleri</span><span
                            class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="/admin/slider-resim-ekle">Slider'a Resim Ekle</a></li>
                    <li><a href="/admin/slider-resimleri">Slider Resimleri</a></li>
                    <li><a href="/admin/slider-islemleri">Slider İşlemleri</a></li>
                </ul>
            </li>
            <li>
