...
<head>
    ...
    <title>@section('title')kare-code Admin Panel @show</title>
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong
                                            class="font-bold">{{\Illuminate\Support\Facades\Auth::user()->fullname}}</strong>
    ...
    <div id="page-wrapper" class="gray-bg">
        <div class="row border-bottom">
            <nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li>
                        <span class="m-r-sm text-muted welcome-message">kare-code Admin Panele Hoş Geldiniz.</span>
                    </li>
                    <li class="dropdown">
        ...
        <div class="footer">
            <div class="pull-right">
                Bu Admin Panel <strong>Fotoğrafçınıbul.com</strong> için özel hazırlanmıştır.
            </div>
            <div>
                <strong>Copyright</strong> kare-code &copy; 2016 - <?= date('Y')?>
            </div>
        </div>
